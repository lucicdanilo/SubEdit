...
function onClick(){
  ...
  var min1 = time_start[3].toString();
  var min2 = time_start[4].toString();
  ...
  var sec1 = time_start[6].toString();
  var sec2 = time_start[7].toString();
  ...
  var mil1 = time_start[9].toString();
  var mil2 = time_start[10].toString();
  var mil3 = time_start[11].toString();
  ...
  var hour1 = time_start[0].toString();
  var hour2 = time_start[1].toString();
  ...
  var min1End = time_end[3].toString();
  var min2End = time_end[4].toString();
  ...
  var sec1End = time_end[6].toString();
  var sec2End = time_end[7].toString();
  ...
  var mil1End = time_end[9].toString();
  var mil2End = time_end[10].toString();
  var mil3End = time_end[11].toString();
  ...
  var hour1End = time_end[0].toString();
  var hour2End = time_end[1].toString();
